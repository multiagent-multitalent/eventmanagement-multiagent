...
## Aufgaben (Checkliste)
- [ ] Event-Basisdaten aus `config/event.yaml` prüfen und bei Bedarf ergänzen
- [ ] Ziele des Events in 3–5 Sätzen formulieren (Was soll AITD 2026 erreichen?)
- [ ] Zielgruppen konkretisieren (Forschende, Praktiker, Studierende, Policymaker – Anteile schätzen)
- [ ] Formatbeschreibung ausarbeiten: Konferenz + Workshops + Hackathon, 3 Tracks, Hauptbühne
- [ ] Thematischen Rahmen der 3 Tracks vorschlagen (basierend auf AI Transparency, Safety, Governance, Human Compatible AI)
- [ ] Erwartetes Programm-Skelett skizzieren: Tag 1 (Eröffnung, Keynotes), Tag 2 (Tracks + Workshops), Tag 3 (Hackathon + Abschluss)
- [ ] Alleinstellungsmerkmale des Events herausarbeiten (Was macht AITD 2026 besonders?)
- [ ] Sprachpolitik festlegen: Deutsch/Englisch-Mix, Übersetzungsbedarf?
- [ ] Konzeptpapier in `workstreams/programm/event-konzept.md` schreiben

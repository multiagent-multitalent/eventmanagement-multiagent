...
## Ziel
Eine übergreifende Kommunikationsstrategie definieren, die Kanäle, Tonalität, Zielgruppen-Ansprache und die wichtigsten Kommunikationsphasen festlegt – als Rahmen für alle nachfolgenden Kommunikations-APs.

## Voraussetzungen (Abhängigkeiten)
- AP-001: Event-Konzept finalisieren (Positionierung, Zielgruppe und Themen müssen bekannt sein)

## Eingaben (Inputs)
- `workstreams/programm/event-konzept.md` – Event-Positionierung und Zielgruppen
- `config/event.yaml` – Veranstalter, Datum, Ort, Sprachen

...
In diesem Block werden die konzeptionellen Grundlagen für Venue und Programm erarbeitet – noch vor der eigentlichen Recherche. Hier entstehen die Anforderungslisten und Konzepte, die als Grundlage für Ausschreibungen, Recherchen und den CfP-Prozess dienen.
...
| AP-007 | CfP-Bewertungsrubrik erstellen | 🟡 Hoch | programm | AP-006 |
...
Alle vier APs können **vollständig parallel** gestartet werden, sobald Block 01 abgeschlossen ist.
...
- [ ] AP-007: `workstreams/programm/cfp-bewertungsrubrik.md` existiert mit Bewertungskriterien
